...
public class OccleveMobileFonts
{
    ...
    public static Font DETAILS_FONT =
            Font.getFont(Font.FACE_PROPORTIONAL,Font.STYLE_ITALIC,Font.SIZE_MEDIUM);

    public static Font SMALL_FONT =
            Font.getFont(Font.FACE_PROPORTIONAL,Font.STYLE_ITALIC,Font.SIZE_SMALL);

    public static Font SMALL_UNDERLINED_FONT =
